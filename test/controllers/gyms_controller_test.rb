...
class GymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gym" do
    assert_difference('Gym.count') do
      post gyms_url, params: { gym: { address: @gym.address, name: @gym.name, phone_number: @gym.phone_number, price_in_cents: @gym.price_in_cents } }
    end
  ...
  test "should update gym" do
    patch gym_url(@gym), params: { gym: { address: @gym.address, name: @gym.name, phone_number: @gym.phone_number, price_in_cents: @gym.price_in_cents } }
